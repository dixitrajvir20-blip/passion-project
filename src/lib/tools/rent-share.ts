...
export const CONFIG: EditionConfigs<RentShareConfig> = {
  eu: {
    ...
    rules: [
      ...
      {
        key: 'overburdenYoung2025',
        value: 9.1,
        label: 'Share of people aged 15 to 29 in the EU living in an overburdened household, 2025 (9.7 in 2024)',
        source: EUROSTAT_BY_AGE,
        asOf: CHECKED,
        inLine: false,
      },
      {
        key: 'overburdenAll2025',
        value: 7.7,
        label: 'Share of all people in the EU living in an overburdened household, 2025 (8.2 in 2024)',
        source: EUROSTAT_BY_AGE,
        asOf: CHECKED,
        inLine: false,
      },
